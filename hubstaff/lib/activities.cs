...
namespace activities_space
{
    class activitiesClass{
		private connection.connection_class connection = new connection.connection_class();
		public Task<string> get_activities (string app_token,string auth_token,string starttime, string stoptime, Dictionary<string, string> options, int offset = 0,String url = "")
        {
